 ...
 * провести новую проверку на онлайн, при наличи запроса от пользователя из INDEX либо иной способ через демона**/


//** Используя текущую дату формируем дату от которой отнимаем 5 минут и сравниваем последний онлайн пользователей в БД **//
  $link = mysqli_connect("127.0.0.1", "root", "", "chat");
  mysqli_set_charset($link, 'utf-8');
  $dateNow = date("Y-m-d H:i:s"); 
  $temp = date("i")-5; //текущиие минуты часа "-5"
  $date = date('Y-m-d H:').$temp.date(':s'); //создаём строку даты с которой нанётся отслеживание онлайна

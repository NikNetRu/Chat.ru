<?php
  ...
  $result = mysqli_query($link, "SELECT ID FROM (users) WHERE (online) BETWEEN STR_TO_DATE('2019-01-01 00:00:00', 'Y-m-d H:i:s') AND STR_TO_DATE('2021-03-04 23:59:59', 'Y-m-d H:i:s')");

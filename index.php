...
<html>
           ...
           $(document).ready (function ()     // JQuerry для всего документа
            {
             ...
             setInterval(function ()        // Периодически обновляет чат - берёт данные из файла logs.html
                ...
                $("#enter").bind("click", function ()   //При нажатии "ENTER" производит вход , в случае ошибки выводит сообщение об ошибке
                    {
                        loginUser (); 
                ...
                //** Функция проверяет введёные данные пользователя, отправляет в БД и получает ответ, выводит пользователю результат **//
    ...
    <body>
        ...
        <div id = "imageLoad" class="imageLoad" hidden="on"> <img src="Img/loader_blue.gif" width="50" height="50" alt="loader_blue"/>
